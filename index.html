...
const BADGES = {
  ...
  'NATURE_GUARDIAN': { threshold: 500, label: 'Nature’s Guardian', color: 'bg-yellow-400', icon: GoldIcon },
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                            ...
                            {userBadges.map(badgeKey => (
                                <div key={badgeKey} className="flex flex-col items-center gap-2">
                                    <BadgeIcon color={BADGES[badgeKey].color} icon={BADGES[badgeKey].icon} />
                                    </BadgeIcon>
